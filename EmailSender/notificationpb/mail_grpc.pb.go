...
const (
	SendMail_SendMail_FullMethodName = "/mail.SendMail/SendMail"
)
...
func (c *sendMailClient) SendMail(ctx context.Context, in *MailRequest, opts ...grpc.CallOption) (*MailResponse, error) {
...
func (UnimplementedSendMailServer) SendMail(context.Context, *MailRequest) (*MailResponse, error) {
...
func RegisterSendMailServer(s grpc.ServiceRegistrar, srv SendMailServer) {
	// If the following call panics, it indicates UnimplementedSendMailServer was
...
func _SendMail_SendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SendMailServer).SendMail(ctx, req.(*MailRequest))
	}
